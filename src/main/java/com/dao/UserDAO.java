...
private Connection conn;
	...
	public UserDAO(Connection conn) {
		...
		// check Admin login
			...
			// view voter/user by email or registration number

			public User getVoterByEmail(String emailOrReg){
				User user = new User();
	...
	public int addVoter(User vtr) {
				...
				ps.setLong(4, Long.parseLong(vtr.getPhone()));
				ps.setString(5,"Not Voted");
				ps.setString(6, "ROLE_NORMAL");
				ps.setString(7, vtr.getRegNo());
			...
			return i;
					...
					// check Voters login (identifier = email or regNo)
					...
					// check Voters login before new voter registration (ensure unique email or regNo)
