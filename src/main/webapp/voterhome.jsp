	  ...
	  <%}
		...
		<form action = "addVote" method ="post">
				...
				<input value ="<%=voter %>" name = "voter" type="hidden" >
			 	<br>
			 	<%
			 	   com.dao.CandidateDAO cdao = new com.dao.CandidateDAO(com.conn.DBConnect.getConn());
			 	   java.util.List<com.entity.Candidate> clist = cdao.getCandidates();
			 	   for(com.entity.Candidate c : clist){
			 	 %>
			 	   <input type="radio" name="Candidates" value = "<%= c.getCandidate() %>"> <%= c.getCandidate() %> <br><br>
			 	 <%
			 	   }
			 	 %>
			    <br>
